...
(N'The House', N'Craiova', N'Pizza pe cuptor de lemne', N'pizza@house.ro', 1),
(N'Burger Queen', N'Bucuresti', N'Her Majesty''s secret burger', N'burger@queen.ro', 3),
(N'Luka', N'Bucuresti', N'Kovrigaria poporului', N'luka@covrigi.ro', 2),
(N'Pizza Hot', N'Bucuresti', N'Your pizza, you way.', N'pizza@hooot.ro', 1),
(N'Peter', N'Bucuresti', N'Traditie din 2025', N'bucuresti@peter.com', 2);
GO